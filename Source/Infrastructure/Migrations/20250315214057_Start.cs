    ...
    public partial class Start : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoryVideo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Posts", x => new { x.InstagramId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stories_StoryImage_ImagesId",
                        column: x => x.ImagesId,
                        principalTable: "StoryImage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stories_StoryVideo_VideosId",
                        column: x => x.VideosId,
                        principalTable: "StoryVideo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PostInstagramId = table.Column<long>(type: "bigint", nullable: false),
                    PostId1 = table.Column<long>(type: "bigint", nullable: false),
                    ImageName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PostId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Images", x => new { x.PostInstagramId, x.PostId1, x.Id });
                    table.ForeignKey(
                        name: "FK_Images_Posts_PostInstagramId_PostId1",
                        columns: x => new { x.PostInstagramId, x.PostId1 },
                        principalSchema: "instagram",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Videos", x => new { x.PostInstagramId, x.PostId1, x.Id });
                    table.ForeignKey(
