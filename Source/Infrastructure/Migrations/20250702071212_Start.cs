    ...
    public partial class Start : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserNotifications", x => new { x.UserId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Images", x => new { x.PostInstagramId, x.PostId, x.Id });
                    table.ForeignKey(
                        name: "FK_Images_Posts_PostInstagramId_PostId",
                        columns: x => new { x.PostInstagramId, x.PostId },
                        principalSchema: "Instagram",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Videos", x => new { x.PostInstagramId, x.PostId, x.Id });
                    table.ForeignKey(
                        name: "FK_Videos_Posts_PostInstagramId_PostId",
                        columns: x => new { x.PostInstagramId, x.PostId },
                        principalSchema: "Instagram",
                        principalTable: "Posts",
                        principalColumns: new[] { "InstagramId", "Id" },
