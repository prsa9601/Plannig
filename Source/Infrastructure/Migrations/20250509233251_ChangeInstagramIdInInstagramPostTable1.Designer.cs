...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250509233251_ChangeInstagramIdInInstagramPostTable1")]
    partial class ChangeInstagramIdInInstagramPostTable1
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Domain.SocialMediaAgg.InstagramAgg.Post.Post", "Posts", b1 =>
                        {
                            ...
                            b1.Property<string>("InstagramPostId")
                                .HasColumnType("nvarchar(max)");
                            ...
                            b1.OwnsMany("Domain.SocialMediaAgg.InstagramAgg.Post.InstagramPostImage", "Images", b2 =>
                                {
                                    ...
                                    b2.HasKey("PostInstagramId", "PostId", "Id");
                                    ...
                                    b2.WithOwner()
                                        .HasForeignKey("PostInstagramId", "PostId");
                                });
