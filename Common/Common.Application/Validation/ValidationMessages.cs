namespace Common.Application.Validation
{
    public static class ValidationMessages
    {
        ...
        public static string maxLength(string field, int maxLength) => $"{field} نمیتواند کمتر از {maxLength} کاراکتر باشد";
        public static string minLength(string field, int minLength) => $"{field} نمیتواند بیشتر از {minLength} کاراکتر باشد";
    }
}